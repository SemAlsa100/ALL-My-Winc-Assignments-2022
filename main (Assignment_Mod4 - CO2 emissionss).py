...
global_co2_emissions = global_co2_emissions.loc[~global_co2_emissions['country'].str.contains(
    "European Union")]

global_co2_emissions = global_co2_emissions.reset_index(drop=True)
